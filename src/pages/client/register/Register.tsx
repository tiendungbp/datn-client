...
const Register = () => {
  ...
  return (
    <div>
      <div className="w-full md:h-full h-full flex flex-col md:flex-row items-start">
        <div className="relative  w-[40%] h-[100vh] flex-col bg-pink-200 hidden md:block">
          <img
        ...
        <div className=" w-full md:w-[60%] md:h-full h-full flex flex-col p-8 md:p-12 lg:px-16 bg-white">

...
import { Breadcrumb, DatePicker, Input, Modal, Select, Space, Table, Tag } from 'antd'
...
const Booking_profile = () => {
  ...
  const columnsBookingProfile: ColumnsType<DataBookingProfileProp> = [
...

    {
      ...
      key: 'action',
      render: (_, record) => (
        <Space size="large" onClick={handleViewClick} className='bg-[#DCEDFF] border border-[#1386ED] hover:bg-[#1386ED] hover:text-white  p-2 px-3 rounded-lg transition-all duration-300'>
      ...
      <div className='m-auto w-wd-primary md:w-wd-secondary mt-12 lg:mt-[4rem] '>
        ...
        <div className='bg-white box-shadow rounded-lg  p-8 mb-12'>
          ...
          <div className='table_booking_profile'>
            <Table columns={columnsBookingProfile} dataSource={dataBookingProfile} pagination={{ pageSize: 5 }} />
          ...
          >
            <div className=' mt-8 mb-4 title_model_booking_profile flex flex-col md:flex-row items-start md:items-center justify-between'>
              <div className=' flex gap-4 items-center '>
                ...
                <p className='text-red-500 font-bold lg:text-[1.1rem]'>Chờ xác nhận</p>
              </div>
              <div className=''>
                <h1 className=' text-[#1386ED] text-[1.5rem] font-bold text-center mb-4'>YÊU CẦU ĐẶT LỊCH HẸN</h1>
              </div>
              <div className=''>
                <button className='py-3 px-6 rounded-lg bg-[#1386ED] text-white font-bold'>Hủy lịch hẹn</button>
              </div>
            ...
            <div className='my-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <div className='flex flex-col gap-4 md:px-8'>
                <h1 className='font-bold md:text-[1.1rem]'>1. Thông tin lịch hẹn</h1>
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-bold text-[#1386ED]'> 13:30 -15:00</span>
              ...
              <div className='flex flex-col gap-4 md:px-8'>
                <h1 className='font-bold md:text-[1.1rem]'>2. Thông tin bệnh nhân</h1>
              ...
              <div className='flex flex-col gap-4 md:px-8'>
                <h1 className='font-bold md:text-[1.1rem]'>3. Thông tin bác sĩ</h1>

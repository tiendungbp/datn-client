...
interface DataBookingProfileProp {
  ...
  // ('lh01a73aa4', 1, 70, 'bn8097f807', 'ltaca98c47', 'Trần Thị Bích', '2000-02-15', 0, '0908765432', 2, '2026-07-09 17:33:30', '2026-07-09 17:35:27'),
  //
  key: string;
            ...
            <div className="my-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="flex flex-col gap-4 md:px-8">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-[#1386ED]"> 04-08-2026</span>
                </div>
                <div className="flex justify-between">

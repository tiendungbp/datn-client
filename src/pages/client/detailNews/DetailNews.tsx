import { Button, Checkbox, Divider, Form, Input, Row, Col } from 'antd'
    ...
    <div className='container_detailNews m-auto'>
      ...
      <div className='main_content flex gap-3 justify-between'>
        <div className='content_leftNews mt-10 relative'>
          <h1 className='main_h1 font-medium text-xl '>Tại sao phòng khám nha khoa ToothHive là địa chỉ lý tưởng cho sức khỏe răng miệng của bạn?</h1>
          <span className='text-gray-500 font-normal mt-4'>Được phát hành ngày 27/01/2023</span>
          <img className='img_news mt-5  object-cover rounded-lg' src="/img/Rectangle 57.png" alt="" />
          <div className='mt-5'>
          ...
          <div className='comment mt-16'>
            ...
            <div className='box_comment mt-10 '>
              <div className='bg-slate-100 px-7 pt-8 pb-12 rounded-lg '>
                ...
                <p className='mt-5 text-sm'>Dịch vụ tại ToothHive rất tốt nhé! Và rất nhiệt tình với khách hàng nữa nhen mọi người ơi 😍🥰</p>
              </div>
            ...
            <span className='font-semibold text-xl'>Để lại một câu trả lời</span>
        ...
        <div className='content_rightNews mt-12'>
          ...
          <h1 className='text-xl h1 font-semibold mt-10'>Dịch vụ tại ToothHive</h1>
          <div className='grid grid-cols-1 gap-3 mt-5 '>
            <div className='flex items-center justify-between'>
              <div className='flex gap-5'>
                <input type="checkbox" /><p className='font-normal text-base '>Niềng răng</p>
              </div>
              <p className='font-normal text-base'>(18)</p>
            </div>
            <div className='flex items-center justify-between'>
              <div className='flex gap-5'>
                <input type="checkbox" /><p className='font-normal text-base '>Nhổ răng</p>
              </div>
              <p className='font-normal text-base'>(11)</p>
            </div>
            <div className='flex items-center justify-between'>
              <div className='flex gap-5'>
                <input type="checkbox" /><p className='font-normal text-base '>Trám răng</p>
              </div>
              <p className='font-normal text-base'>(10)</p>
            </div>
            <div className='flex items-center justify-between'>
              <div className='flex gap-5'>
                <input type="checkbox" /><p className='font-normal text-base '>Trồng răng</p>
              </div>
          ...
          <div className='flex items-center justify-between'>
            <h2 className='font-semibold text-xl'>Các bài viết liên quan </h2><UpOutlined className='float-right' />
          </div>
          <div className='flex items-center gap-5 mt-7'>
            <img className='rounded-lg' src="/img/blog_small_img_3.jpg.png" alt="" />
            <div>
              <h4 className='font-medium text-sm'>5 Dịch Vụ Nổi Bật Tại Phòng Khám Nha Khoa Để Có...</h4>
              <p className='text-xs'>Để có được một hàm răng đẹp rạng ngời tại Tooth...</p>

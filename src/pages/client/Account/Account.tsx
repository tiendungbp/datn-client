					...
					<div className="box-shadow rounded-lg p-4">
						...
						<Row>
							<Col className="flex items-center flex-wrap">
								...
								/>
								<label
									className="border-blue-400 text-blue-400 btn-choose-avatar btn bg-white border border-black-50 mx-2 border-1 px-4 py-2 rounded-md  hover:text-sky-600 hover:bg-sky-200 hover:border-sky-600"
									htmlFor="avatar"
